...
const Profile = () => {
  ...
  // Dati di esempio per le auto nel garage
  const cars = [
    {
      id: 1,
      make: 'Alfa Romeo',
    ...
    },
    {
      ...
      model: '911 GT3',
      year: 2022,
      image: 'https://images.unsplash.com/photo-1614162692292-7ac56d7f373e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
      specs: {
        power: '510 CV',
        engine: '4.0L Flat-6',
            ...
            <TabsContent value="garage" className="space-y-4">
              {cars.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {cars.map(car => (
                    <BlurredCard key={car.id} className="overflow-hidden hover:shadow-lg transition-all">
